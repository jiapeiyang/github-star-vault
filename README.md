...
当前事实快照包含 284 条公开 Stars，其中 36 条已建立正式策展文件。首次导入的未整理项目进入 `imported`；自动建议在 MVP 中关闭。
...
- 已导入当前 284 条公开 Stars，并建立 36 条正式策展内容。
...
> 最近成功检查：`2026-09-04T19:33:51Z` · 当前公开 Stars：**284** · 已人工整理：**36**
